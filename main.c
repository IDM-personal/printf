...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/07/27 21:00:32 by marvin            #+#    #+#             */
/*   Updated: 2021/01/30 12:14:23 by idelgado         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main()
{
	...
	printf("{%d}\n", printf("\033[1;32mTest 2b => \033[0m|%05.2s|", "Number 42"));
	ft_printf("{%d}\n", ft_printf("\033[1;31mTest 2b => \033[0m|%05.2s|", "Number 42"));
	...
	printf("{%d}\n", printf("\033[1;32mTest 16b => \033[0m|%15.5s|", "Number 42"));
	ft_printf("{%d}\n", ft_printf("\033[1;31mTest 16b => \033[0m|%15.5s|", "Number 42"));
	...
	printf("{%d}\n", printf("\033[1;32mTest 12 => \033[0m|%00.0d|", 42));
	ft_printf("{%d}\n", ft_printf("\033[1;31mTest 12 => \033[0m|%00.0d|", 42));
	...
	printf(" ---> {%i}\n", printf("<sfg%2Hola como va la people?>"));
	ft_printf(" ---> {%i}\n", ft_printf("<sfg%2Hola como va la people?>"));
	...
	printf(" ---> {%i}\n", printf("<%*.i>", 30, 2147483647));
	ft_printf(" ---> {%i}\n", ft_printf("<%*.i>", 30, 2147483647));
	...
	printf("{%i}\n", printf("%s", "testing0 testing1"));
	ft_printf("{%i}\n", ft_printf("%s", "testing2 testing3"));
	printf("{%i}\n", printf("%%"));
	ft_printf("{%i}\n", ft_printf("%%"));
	...
	printf("{%i}\n", printf("%5c", '\0'));
	ft_printf("{%i}\n", ft_printf("%5c", '\0'));
	printf("{%i}\n", printf("%d", 4294967296/2));
	ft_printf("{%i}\n", ft_printf("%d", 4294967296/2));
